...
/*
 ...
 - Used linkedList as adding and removing would be quicker, but still thinking if an array list might have been
...
private:
    ...
    // Admin default access [Temp will probably implement a structured array of admin users with Unique password
    // according to name and password match
